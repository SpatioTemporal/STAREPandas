#!/usr/bin/env python3
"""
Example script demonstrating bidirectional zarr path operations.

This script shows how to use both generate_zarr_path and parse_zarr_path
functions together for hierarchical zarr storage organization.
"""
...
def example_basic_bidirectional():
    ...
    path = sdf.generate_zarr_path(original_sid, dataset_name)
...
def main():
    """Run all examples."""
    print("STARE SID Bidirectional Zarr Path Operations")
    print("=" * 60)
    ...
    print("✓ generate_zarr_path: SID → Hierarchical Path")
    print("✓ parse_zarr_path: Hierarchical Path → SID + Dataset")
    print("✓ Level structure preservation in both directions")
    print("✓ Spatial organization and query capabilities")
    print("✓ Comprehensive validation and error handling")
    print("✓ Perfect for zarr storage organization")
    
    print("\nKey Use Cases:")
    print("1. **Storage Organization**: Create hierarchical zarr storage")
