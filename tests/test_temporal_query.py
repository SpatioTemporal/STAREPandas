...
from starepandas.demo_lib import LocalStarePodsDemo, StarePodsDemo
...
def _single_pod_sdf(lat=37.0, lon=-120.0, n=7,
...
def _write(tmp_path, sdf, dataset='GMI_S1', granule_name='G1',
...
def _two_pod_demo(tmp_path):
    ...
    ca = _single_pod_sdf(lat=37.0, lon=-120.0)
    au = _single_pod_sdf(lat=-25.0, lon=134.0,
